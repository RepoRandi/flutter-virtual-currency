...
class ExchangeRateScreenController extends State<ExchangeRateScreenView> {
  static late ExchangeRateScreenController instance;
  late ExchangeRateScreenView view;
