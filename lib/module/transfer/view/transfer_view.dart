                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            showMenu(
                              context: context,
                              position:
                                  const RelativeRect.fromLTRB(50, 170, 50, 0),
                              ...
                              if (value != null) {
                                controller.updateSelectedFromOutlet(value);
                              }
                            });
                            controller.toggleMenuFromOutlet();
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(
                                controller.optionFromOutlet,
                                style: GoogleFonts.roboto(
                                  color: blueColor,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
                              ...
                              Icon(
                                controller.isMenuFromOutletOpen
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            showMenu(
                              context: context,
                              position:
                                  const RelativeRect.fromLTRB(255, 170, 255, 0),
                              items: <PopupMenuEntry<String>>[
                                PopupMenuItem<String>(
                                  value: 'Outlet 1',
                                  child: Text(
                              ...
                              if (value != null) {
                                controller.updateSelectedToOutlet(value);
                              }
                            });
                            controller.toggleMenuToOutlet();
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(
                                controller.optionToOutlet,
                                style: GoogleFonts.roboto(
                                  color: blueColor,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () => controller.trxTransfer(),
