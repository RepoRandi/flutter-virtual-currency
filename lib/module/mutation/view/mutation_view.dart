...
class MutationView extends StatefulWidget {
  const MutationView({Key? key}) : super(key: key);

  Widget build(context, MutationController controller) {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () => controller.toggleDate(context),
                child: Container(
                  width: 280,
                  height: 30,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${DateFormat('dd/MM/yyyy').format(controller.selectedDateStart)} - ${DateFormat('dd/MM/yyyy').format(controller.selectedDateEnd)}',
                        style: GoogleFonts.roboto(
                          color: blueColor,
                          fontSize: 10,
  ...
  @override
  State<MutationView> createState() => MutationController();
}
